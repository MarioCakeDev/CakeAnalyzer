...
using Xunit;
using Verify = Microsoft.CodeAnalysis.CSharp.Testing.XUnit.AnalyzerVerifier<Analyzers.NoXmlCommentAnalyzer>;

namespace Analyzers.Tests
{
    public class NoXmlCommentAnalyzerTests
    {
        private const string RuleId = NoXmlCommentAnalyzer.RuleId;
