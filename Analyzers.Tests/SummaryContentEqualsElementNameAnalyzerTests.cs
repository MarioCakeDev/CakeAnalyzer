...
using Xunit;
using Verify = Microsoft.CodeAnalysis.CSharp.Testing.XUnit.AnalyzerVerifier<Analyzers.SummaryContentEqualsElementNameAnalyzer>;

namespace Analyzers.Tests
{
    public class SummaryContentEqualsElementNameAnalyzerTests
    {
        private const string RuleId = SummaryContentEqualsElementNameAnalyzer.RuleId;
